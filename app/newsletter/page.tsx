          ...
          <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            <div className="max-w-2xl mx-auto text-center space-y-8">
              ...
              <div className="space-y-4">
                <h1 className="text-4xl sm:text-5xl font-bold text-gray-900">Welcome to the NOW AI Newsletter!</h1>
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center py-4">
            ...
            <nav className="hidden md:flex items-center space-x-8">
              ...
              <a href="/newsletter" className="text-green-600 hover:text-green-700 transition-colors font-bold">
                Newsletter
              </a>
            </nav>
            <div className="flex items-center space-x-3">
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-start">
            ...
            <div>
              <Card className="shadow-2xl border border-green-100">
                <CardHeader>
                  <CardTitle className="text-2xl text-gray-900">Subscribe to NOW AI Newsletter</CardTitle>
                ...
                <CardContent>
                  <form onSubmit={handleSubmit} className="space-y-6">
                    ...
                    <p className="text-xs text-gray-500 text-center">
                      By subscribing, you agree to receive marketing emails from NOW AI. You can unsubscribe at any
                      time.
                    </p>
                  </form>
                </CardContent>
      ...
      <section className="py-20 bg-gradient-to-r from-green-500 to-emerald-600">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <div className="max-w-3xl mx-auto space-y-8">
            <h2 className="text-3xl sm:text-4xl font-bold text-white">Ready to Transform Your Practice?</h2>
            <p className="text-xl text-green-100">
              Don't just read about AI success stories—create your own. Schedule a consultation to see how our solutions
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Button
                size="lg"
                variant="secondary"
                className="text-lg px-8 py-3 bg-white text-green-600 hover:bg-gray-50 rounded-full"
              >
              ...
              <Button
                size="lg"
                variant="outline"
                className="text-lg px-8 py-3 border-white text-white hover:bg-white hover:text-green-600 rounded-full"
              >
                View All Solutions
              </Button>
            </div>
