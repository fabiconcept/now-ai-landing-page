...
import { CheckCircle, ArrowRight, Users, Building2, Zap, Globe, BarChart3, Headphones } from "lucide-react"
                ...
                <div className="container mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="flex justify-between items-center py-4">
                        ...
                        <nav className="hidden md:flex items-center space-x-8">
                            ...
                            <Link href="/pricing" className="text-green-600 hover:text-green-700 transition-colors font-bold">
                                Pricing
                            </Link>
